...
namespace NBALigaSimulation.Server.Migrations
{
    ...
    [Migration("20230605004453_Users")]
    partial class Users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NBALigaSimulation.Shared.Models.User.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NBALigaSimulation.Shared.Models.User.User", b =>
                {
                    b.HasOne("NBALigaSimulation.Shared.Models.Team", "Team")
                        .WithOne()
                        .HasForeignKey("NBALigaSimulation.Shared.Models.User.User", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
